...
- **Backend:** Python FastAPI with a multi-agent Claude pipeline and SSE streaming
- **Frontend:** React 18 + Vite + TypeScript + Tailwind CSS

The app takes a learning goal from the user, runs it through four specialized Claude agents, and displays an interactive roadmap in the browser with real-time agent progress updates.
...
10. Footer: "Generated by AI Learning Roadmap Creator · Powered by Claude AI"
```
...
- Call `client.messages.create()` with `model="claude-sonnet-4-20250514"` and `max_tokens=4096`
...
**Feedback type classification** — add a small helper that calls Claude to classify feedback as `"structure"`, `"resources"`, or `"format"`:
